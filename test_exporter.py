...
chname_ip_default_dct = {'10.231.4.103': 'o1-g620-003-vc5-f1'}
...
def create_chname_ip_db_file(db_dir, chname_ip_db_filename, chname_ip_default_dct=None):

    if not chname_ip_default_dct:
...
def update_chname_ip_db(chname_ip_dct, ch_parser, chname_ip_db_dir, chname_ip_db_filename):
    ...
    if not chname_ip_dct.get(sw_ipaddress) or chname_ip_dct[sw_ipaddress] != ch_parser.ch_name:
        ...
        print(f'chname_ip_dct: {chname_ip_dct}')
...
# io rate
o3_g630_003_vc01_f1_b.fc_statistics[-1]['Response']['fibrechannel-statistics'][0]['in-rate'] = 3_275_000_000
